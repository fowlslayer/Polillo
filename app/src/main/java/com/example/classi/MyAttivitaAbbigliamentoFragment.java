...
public class MyAttivitaAbbigliamentoFragment extends Fragment{

    Button modifica, elimina, btnModifca, btnNonModifca, btnElimina, btnNonElimina;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_negozio_abbigliamento, container, false);

        setCustomTitle(getString(R.string.titoloNegozioAbbigliamento));
