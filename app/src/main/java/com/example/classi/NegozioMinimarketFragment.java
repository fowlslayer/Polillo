...
public class NegozioMinimarketFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_negozio_minimarket, container, false);

        setCustomTitle(getString(R.string.titoloNegozioMinimarket));
