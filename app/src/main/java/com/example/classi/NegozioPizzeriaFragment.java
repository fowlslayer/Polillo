...
public class NegozioPizzeriaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_negozio_pizzeria, container, false);

        setCustomTitle(getString(R.string.titoloNegozioPizzeria));
